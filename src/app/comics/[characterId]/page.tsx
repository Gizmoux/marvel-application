...
// 		fetchData();
// 	}, [params.characterId]);
// 	// console.log('characterId', params.characterId);

// 	return (
// 		<div>
// 			<Navbar />
// 			Mon character ID est {params.characterId}
// 			<div className="md:grid md:grid-cols-3 w-full ">
// 				{data && data.comics && data.comics.length > 0 ? (
// 					data.comics.map(comic => (
// 						<div
// 							key={comic._id}
// 							className="bg-red-300 hover:bg-red-400 mb-2 mr-2 ml-2 flex flex-col items-center rounded-md"
// 						>
// 							<h3 className="text-white scroll-m-20 text-md font-semibold tracking-tight">
// 								{comic.title}
// 							</h3>
// 							<Image
// 								width={200}
...
// 								src={`${comic.thumbnail.path}.${comic.thumbnail.extension}`}
// 								alt={comic.title}
// 								className="rounded-md flex justify-center bt-2"
// 							/>
// 							<p className="text-center leading-7 [&:not(:first-child)]:mt-6 line-clamp-2">
// 								{comic.description}
// 							</p>
// 						</div>
// 					))
